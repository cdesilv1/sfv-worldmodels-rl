...
# STREET FIGHTER COMMAND FUNCTIONS#########################################################

def light_kick():
    SendInput(Keyboard(KEY_B))
    SendInput(Keyboard(KEY_B, KEYEVENTF_KEYUP))
...
def all_kick():
    SendInput(Keyboard(VK_OEM_COMMA))
    SendInput(Keyboard(VK_OEM_COMMA, KEYEVENTF_KEYUP))
...
#######################################################################################################################
def main():
    # basic_movements = [SendInput(Keyboard(VK_UP)), SendInput(Keyboard(VK_DOWN)), SendInput(Keyboard(VK_LEFT)), SendInput(Keyboard(VK_RIGHT)), do_nothing()]
    # basic_attacks = [light_kick(), light_punch(), medium_punch(), medium_kick(), heavy_kick(), heavy_punch(), all_kick(), all_punch(), do_nothing()]
    time.sleep(8)
